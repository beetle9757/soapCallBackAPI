...
import com.infrasofttech.config.fts.callback.response.stub.AMLScanResponse;
...
public class WssSecurityResponseUnmarshallTest extends WebServiceGatewaySupport {
	...
	public void unmarshalTest() throws IOException, SOAPException {
		...
		marshaller.setPackagesToScan("com.infrasofttech.config.fts.callback.response.stub");
		String input = """
